/* ===========================================================================
 * $RCS$
 * Version: $Id: RowFixtureWrapper.java,v 2.3 2006/02/25 20:50:44 shahzad Exp $
 * ===========================================================================
 *
 ...
 * 12/9/05      SB              created.
 */
public class RowFixtureWrapper extends RowFixture {
  /**
   * RowFixtureWrapper constructor
   * @param rows - array of objects
   * @param type - type
   */
  public RowFixtureWrapper(Object[] rows, Class type) {
    set(rows); 
    this.type = type;
  }
