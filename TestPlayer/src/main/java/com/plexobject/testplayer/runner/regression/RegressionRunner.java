/* ===========================================================================
 * $RCS$
 * Version: $Id: RegressionRunner.java,v 1.13 2006/02/25 20:50:56 shahzad Exp $
 * ===========================================================================
 *
...
public class RegressionRunner extends BaseTestRunner {
  /**
   * RegressionRunner - runs regression test
   * @param file - directory where serialized method data is stored.
   */
  public RegressionRunner(File file) {
    super(file);
    if (logger.isEnabledFor(Level.INFO)) {
       logger.info("RegressionRunner file constructor");
    }
  }
  ...
  public static Test suite() {
    ...
    return new RegressionLoader().newSuite();
  }
  ...
  public static void main(String[] args) { 
    if (logger.isEnabledFor(Level.INFO)) {
       logger.info("RegressionRunner running suites of tests using data driven pattern");
    }
